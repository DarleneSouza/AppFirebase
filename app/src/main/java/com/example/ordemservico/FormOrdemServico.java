...
public class FormOrdemServico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextServico = findViewById(R.id.editTextCpf);
        editTextPrdutos = findViewById(R.id.editTextPrdutos);
        editTextValorServico = findViewById(R.id.editTextEndereco);
        ...
        textViewInformacaoOS = findViewById(R.id.textViewInformacaoCliente);
